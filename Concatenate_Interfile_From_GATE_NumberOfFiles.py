...
####################################### Code To concatenate interfile data (.hdr .sin) from GATE #######################
## Usage: python3 Concatenate_Interfile_From_GATE.py path output_filename nFiles
# the number of files to merged is optional (nFiles)
## Example: python3 Concatenate_Interfile_From_GATE_NumberOfFiles.py Brain_Perfusion/LEHR_NoAttn_0.05Bq/Proj Brain_Perfusion_LEHR_NoAttn_0.05Bq 100
## Example: python3 Concatenate_Interfile_From_GATE_NumberOfFiles.py Brain_Perfusion/LEHR_NoAttn_0.05Bq/Proj Brain_Perfusion_LEHR_NoAttn_0.05Bq
